...
/**
 * Preferences API Proxy Route Handler
 *
 * This route handler proxies user preferences requests to the backend and properly
...
async function proxyRequest(request: NextRequest, path: string[]) {
  const targetPath = `/api/preferences/${path.join('/')}`;
