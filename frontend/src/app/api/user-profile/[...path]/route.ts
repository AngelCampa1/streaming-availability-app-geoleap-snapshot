...
/**
 * User Profile API Proxy Route Handler
 *
 * This route handler proxies user profile requests to the backend and properly
...
async function proxyRequest(request: NextRequest, path: string[]) {
  const targetPath = `/api/user-profile/${path.join('/')}`;
