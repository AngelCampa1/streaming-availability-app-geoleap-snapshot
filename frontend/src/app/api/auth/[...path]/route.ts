...
/**
 * Auth API Proxy Route Handler
 *
 * This route handler proxies auth requests to the backend and properly
 * forwards Set-Cookie headers back to the client.
 *
 * Next.js rewrites DO NOT forward Set-Cookie headers, which breaks
 * httpOnly cookie-based authentication. This handler solves that.
 */
