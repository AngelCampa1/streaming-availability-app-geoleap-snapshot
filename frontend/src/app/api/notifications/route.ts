...
/**
 * Notifications API Base Route Handler
 *
 * Handles requests to /api/notifications (without additional path segments)
 * Forwards cookies for authentication to the backend.
 */
...
async function proxyRequest(request: NextRequest) {
  ...
  const targetUrl = `${BACKEND_URL}/api/notifications${queryString}`;
