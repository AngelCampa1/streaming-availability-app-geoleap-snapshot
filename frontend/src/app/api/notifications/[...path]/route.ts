...
/**
 * Notifications API Proxy Route Handler
 *
 * This route handler proxies notification requests to the backend and properly
...
async function proxyRequest(request: NextRequest, path: string[]) {
  const targetPath = `/api/notifications/${path.join('/')}`;
