 ...
 *
 * Tests for the Privacy Policy screen component
  ...
  describe('Rendering', () => {
    it('should render the WebViewScreen component', () => {
      const { getByTestId } = renderWithProviders(
        <PrivacyPolicyScreen navigation={mockNavigation as any} route={{} as any} />
      );
    ...
    it('should pass correct title to WebViewScreen', () => {
      ...
      expect(getByTestId('webview-title').props.children).toBe('Privacy Policy');
    });
    ...
    it('should pass correct URL to WebViewScreen', () => {
      ...
      expect(getByTestId('webview-url').props.children).toBe('https://geoleap.app/privacy');
    });
